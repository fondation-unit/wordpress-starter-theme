...
const pn="undefined"!=typeof document&&document.documentMode,gn={rootMargin:"0px",threshold:0,load(t){if("picture"===t.nodeName.toLowerCase()){let e=t.querySelector("img"),n=!1;null===e&&(e=document.createElement("img"),n=!0),pn&&t.getAttribute("data-iesrc")&&(e.src=t.getAttribute("data-iesrc")),t.getAttribute("data-alt")&&(e.alt=t.getAttribute("data-alt")),n&&t.append(e)}if("video"===t.nodeName.toLowerCase()&&!t.getAttribute("data-src")&&t.children){const e=t.children;let n;for(let t=0;t<=e.length-1;t++)n=e[t].getAttribute("data-src"),n&&(e[t].src=n);t.load()}t.getAttribute("data-poster")&&(t.poster=t.getAttribute("data-poster")),t.getAttribute("data-src")&&(t.src=t.getAttribute("data-src")),t.getAttribute("data-srcset")&&t.setAttribute("srcset",t.getAttribute("data-srcset"));let e=",";if(t.getAttribute("data-background-delimiter")&&(e=t.getAttribute("data-background-delimiter")),t.getAttribute("data-background-image"))t.style.backgroundImage=`url('${t.getAttribute("data-background-image").split(e).join("'),url('")}')`;else if(t.getAttribute("data-background-image-set")){const n=t.getAttribute("data-background-image-set").split(e);let i=n[0].substr(0,n[0].indexOf(" "))||n[0];i=-1===i.indexOf("url(")?`url(${i})`:i,1===n.length?t.style.backgroundImage=i:t.setAttribute("style",(t.getAttribute("style")||"")+`background-image: ${i}; background-image: -webkit-image-set(${n}); background-image: image-set(${n})`)}t.getAttribute("data-toggle-class")&&t.classList.toggle(t.getAttribute("data-toggle-class"))},loaded(){}};function mn(t){t.setAttribute("data-loaded",!0)}function _n(t){t.getAttribute("data-placeholder-background")&&(t.style.background=t.getAttribute("data-placeholder-background"))}const bn=t=>"true"===t.getAttribute("data-loaded"),vn=(t,e=document)=>t instanceof Element?[t]:t instanceof NodeList?t:e.querySelectorAll(t);!function(t=".lozad",e={}){const{root:n,rootMargin:i,threshold:s,load:o,loaded:r}=Object.assign({},gn,e);let a;"undefined"!=typeof window&&window.IntersectionObserver&&(a=new IntersectionObserver(((t,e)=>(n,i)=>{n.forEach(n=>{(n.intersectionRatio>0||n.isIntersecting)&&(i.unobserve(n.target),bn(n.target)||(t(n.target),mn(n.target),e(n.target)))})})(o,r),{root:n,rootMargin:i,threshold:s}));const l=vn(t,n);for(let t=0;t<l.length;t++)_n(l[t])}(".lozad",{threshold:0}),(t=>{t("body").append('<div id="back_top" class="bg-primary"><i class="fas fa-arrow-up text-white"></i></div>'),t("#back_top").click(function(){t("html,body").animate({scrollTop:0},"slow")}),t(window).width(),t(window).scroll(function(){0===t(window).scrollTop()?t("#back_top").fadeOut():t("#back_top").fadeIn()}),t(".search-toggle").on("click",()=>{t(".search-form-div").toggleClass("show")});let e=t("body").height();t(document).ready(()=>{!function(t){t<3e3?(jQuery(".both-bgs").css("background-position","left 120%, right 300%"),jQuery(".one-bg").css("background-position","left 120%")):(jQuery(".both-bgs").css("background-position","left 35%, right 115%"),jQuery(".one-bg").css("background-position","left 35%"))}(e);let n=t(".custom-logo-link img").attr("data-src");t(".custom-logo-link img").attr("src",n)})})(jQuery),t.Alert=I,t.Button=M,t.Carousel=B,t.Collapse=Q,t.Dropdown=ke,t.Modal=We,t.Offcanvas=Qe,t.Popover=sn,t.Scrollspy=rn,t.Tab=ln,t.Toast=fn,t.Tooltip=nn});
